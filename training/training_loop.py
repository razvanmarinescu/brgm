...
def training_loop(
    ...
    image_snapshot_ticks    = 100,       # How often to save image snapshots? None = only save 'reals.png' and 'fakes-init.png'.
    network_snapshot_ticks  = 100,       # How often to save network snapshots? None = only save 'networks-final.pkl'.
