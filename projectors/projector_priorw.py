...
class Projector:
    ...
    def set_network(self, Gs, minibatch_size=1):
        ...
        #print('self._dlatents_var', self._dlatents_var.shape)
        ...
        #print('dlatents_noise',dlatents_noise.shape)
        #dlatents_plus_noise = self.dlatents_var + dlatents_noise 
        #self._dlatents_expr = tf.tile(dlatents_plus_noise, [1, self._Gs.components.synthesis.input_shape[1], 1])
        ...
        print('_dlatents_expr.shape',self._dlatents_expr.shape)
        ...
        zeta = 100
        #zeta = 0.0
        self._w_loss = zeta * tf.reduce_mean(tf.squared_difference(self._dlatents_expr/ self._dlatent_std, self._dlatent_avg/self._dlatent_std))
